...
class TrainingArguments(HFTrainingArguments):
    ...
    loss_diversity_lambda: Optional[float] = field(default=0.01)
...
class DataArguments:
    ...
    plvr_mode: bool = field(default=False)
    nlvr_mode: bool = field(default=False)
    nlvr_noise_scale: float = field(default=0.3)
    expansion_factor: float = field(default=1.3)
    include_free_stage: bool = field(default=False)
    num_free_tokens: int = field(default=6)
